        ...
        <div class="w-96 p-6 rounded-lg bg-blue-900 shadow-xl">
            ...
            <form method="POST" action="{{ route('register') }}" class="pt-6">
                ...
                <div class="relative pt-3">
                    ...
                    <input id="password-confirm" type="password" class="w-full p-3 pt-8 rounded focus:outline-none focus:bg-blue-700 bg-blue-800 text-gray-100 @error('password') border border-red-600 @enderror" name="password_confirmation" placeholder="Confirm Password">
                </div>
                ...
                <div class="pt-6 flex justify-between text-white text-sm font-bold">
                    ...
                    <a class="hover:text-blue-200" href="{{ route('login') }}">Log In</a>
                </div>
            </form>
        </div>
    </div>
