<template>
    <div class="h-screen antialiased">
        <div class="flex">
            <!-- Left Side Bar Nav -->
            <div class="bg-gray-300 w-48 h-screen border-r-2 border-gray-400 pl-6">
                <nav class="pt-6">
                    <router-link to="/" exact-active-class="exact-active" exact>
                        <svg class="fill-current text-blue-600 ml-12 w-12 h-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <div class="pt-12 uppercase font-bold text-sm text-gray-600">Create</div>

                    <router-link to="/contacts/create" class="flex items-center py-3 hover:text-blue-500 border-r-2 hover:border-indigo-400">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current text-blue-600 w-6 h-6"><path d="M19 10h2a1 1 0 0 1 0 2h-2v2a1 1 0 0 1-2 0v-2h-2a1 1 0 0 1 0-2h2V8a1 1 0 0 1 2 0v2zM9 12A5 5 0 1 1 9 2a5 5 0 0 1 0 10zm0-2a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm8 11a1 1 0 0 1-2 0v-2a3 3 0 0 0-3-3H7a3 3 0 0 0-3 3v2a1 1 0 0 1-2 0v-2a5 5 0 0 1 5-5h5a5 5 0 0 1 5 5v2z"/></svg>
                    ...
                    <div class="pt-12 uppercase font-bold text-sm text-gray-600">General</div>

                    <router-link to="/a" class="flex items-center py-3 hover:text-blue-500 border-r-2 hover:border-indigo-400">
                        <div>
                    ...
                    <router-link to="/b" class="flex items-center py-3 hover:text-blue-500 border-r-2 hover:border-indigo-400">
                        <div>
                    ...
                    <div class="pt-12 uppercase font-bold text-sm text-gray-600">Settings</div>

                    <router-link to="/c" class="flex items-center py-3 hover:text-blue-500 border-r-2 hover:border-indigo-400">
                        <div>
            ...
            <div class="flex flex-col flex-1 h-screen overflow-y-hidden bg-gray-100">
                ...
                <div class="h-16 px-6 border-b border-gray-400 flex items-center justify-between">
                    ...
                    <div class="rounded-full text-white bg-blue-400 h-10 w-10 flex justify-center items-center border border-gray-400">
                        AD
                    </div>
                </div>
...
<style scoped>
    .router-link-exact-active {
        @apply border-r-2 border-indigo-600
    }
</style>